...
def main():
    ...
    # Save/Load buttons
    SAVE_SURF, SAVE_RECT = makeText('SAVE', TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 320, WINDOWHEIGHT - 90)
    LOAD_SURF, LOAD_RECT = makeText('LOAD', TEXTCOLOR, TILECOLOR, WINDOWWIDTH - 320, WINDOWHEIGHT - 60)
